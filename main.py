...
from selectionmenu import selection_menu
...
class Game():
    def __init__(self,screen, debugging = False):
        self.screen = screen
        self.dt = 1
        self.window_scale = 1
        self.fps = 60
        ...
        self.objects = []
        self.UI = []
        self.arenas = ["jungle", "mounts", "mounts2"]
        self.arena_index = 2
        
        self.winner = "Nobody"

        self.player_character = "K. Onami"
    ...
    def arena(self, value):
        ...
        if type(value)==str:
            try:
                self.background_index = self.arenas.index(value)
            except:
                pass
    ...
    @property
    def powerups(self):
        return [obj for obj in self.objects if isinstance(obj, PowerUp)]
